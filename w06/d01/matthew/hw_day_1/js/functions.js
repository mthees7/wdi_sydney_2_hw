...
//====================================================
  ...
  var value1 = prompt("Please enter the first value");
  var enumerator = prompt("Please enter the math function you would like to perform")
  var value2 = prompt("Please enter the second value");

  var calculator = function (value1, enumerator, value2){
    if (enumerator === 'multiply') {
      console.log(value1 + ' * ' + value2 + ' = ' + (value1 * value2))
    } else if (enumerator === 'divide') {
      console.log(value1 + ' / ' + value2 + ' = ' + (value1 / value2))
    } else if (enumerator === 'add') {
      console.log(value1 + ' + ' + value2 + ' = ' + (value1 + value2))
    } else if (enumerator === 'subtract') {
      console.log(value1 + ' - ' + value2 + ' = ' + (value1 - value2))
    }
  }

  console.log(calculator(value1, enumerator, value2))
...
//====================================================
  ...
  var direction = prompt("'to pounds' or 'to dollars' ?")

  var dollarsToPounds = function (dollar_value, direction){
    if (direction === 'to pounds') {
      console.log('Dollar value in GBP = ' + (dollar_value * .5951))
    }
  }

  var poundsToDollars = function (pound_value, direction){
    if (direction === 'to dollars') {
      console.log('Pound value in AUD = ' + (pound_value * 1.68))
    }
  }
  ...
  if (direction === 'to pounds'){
    var dollar_value = prompt("Dollar Value?")
    dollarsToPounds(dollar_value, direction)
  }



  if (direction === 'to dollars'){
    var pound_value = prompt("Pound Value?")
    poundsToDollars(pound_value, direction)
  }
...
//====================================================
  ...
  var thisThat = function (randomThis, randomThat){
    console.log('So your startup is like a ' + randomThis + ' for ' + randomThat)
  }
